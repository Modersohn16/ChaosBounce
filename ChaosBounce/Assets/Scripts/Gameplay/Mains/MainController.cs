...
public class MainController : MonoBehaviour
{
    ...
    public LayerMask pauseOnAchievements;
    public GameObject achievementsMenu;
    public AchievementsMenu achievementsMenuScript;
    ...
    public void PauseForAchievements(bool showAchievements = true)
    {
        Time.timeScale = 0;
        paused = true;
        Debug.Log("PauseForAchievements");
        if (showAchievements)
        {
    ...
    {
        cam.cullingMask = pauseOnAchievements;
        achievementsMenuScript.UpdateAchievements();
    ...
    // to prevent shooting when clicking resume button
    IEnumerator UnPauseDelay(float delay)
    {
